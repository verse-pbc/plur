...
### Internal Changes
- Added linting as a part of CI [#65](https://github.com/verse-pbc/issues/issues/65)
- Added unit test runs to CI [#167](https://github.com/verse-pbc/issues/issues/167)
