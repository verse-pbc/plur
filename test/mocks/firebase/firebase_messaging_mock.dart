...
/// A collection of mock implementations for Firebase Messaging functionality.
/// These mocks provide a comprehensive test environment for Firebase Cloud Messaging
/// (FCM) features, including token management and message handling.
///
...
///
/// For tests that only need basic Firebase initialization, use the mocks in
/// `firebase_core_mock.dart` instead.
...
/// Mock implementation of FirebaseMessaging that provides a testable
/// implementation of FCM functionality.
class MockFirebaseMessaging extends Mock implements FirebaseMessaging {
  ...
  /// Sets the mock FCM token that will be returned by getToken()
  void setMockToken(String token) {
    _mockToken = token;
  }

  /// Simulates a token refresh event by updating the mock token and
  /// emitting it through the token refresh stream
...
/// Mock implementation of FirebaseMessagingPlatform that provides the platform
/// interface implementation for FCM functionality
...
/// Sets up all necessary Firebase Core mocks for testing.
/// This includes method channel mocks and platform interface mocks.
...
/// Gets the current mock instance of FirebaseMessaging
MockFirebaseMessaging getMockFirebaseMessaging() {
  return MockFirebaseMessaging.instance;
}

/// Sets up all necessary Firebase Messaging mocks for testing.
/// This includes Firebase Core mocks, method channel mocks, and
